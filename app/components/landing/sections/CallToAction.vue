...
<template>
  <section class="w-full bg-background py-112 md:py-24 px-4 sm:px-6 lg:px-8">
    <div
      ...
      <div class="hidden lg:block absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <!--Right Arcs-->
        <div class="absolute right-[-200px] bottom-[-150px] -translate-x-1/2 flex items-center justify-center">
          <!--Inner Arc-->
          <div class="w-[600px] h-[550px] border-[2px] border-[#FFFFFF]/100 rounded-full"></div>
          <!--Outer Arc-->
          <div class="absolute w-[750px] h-[750px] border-[2px] border-[#FFFFFF]/100 rounded-full"></div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 items-stretch h-full relative z-10">
        ...
        <div class="p-8 sm:p-12 md:p-16 lg:p-24 lg:pr-12 space-y-8">
          <div class="space-y-6">
            <h2 class="text-4xl sm:text-5xl md:text-6xl font-extrabold text-[#0F172A] leading-[1.1] tracking-tight">
              Ready to Automate <br />
              <span class="text-[#38BDF8]">Your Wealth?</span>
            </h2>
            <p class="text-base md:text-xl text-[#334155] leading-relaxed max-w-lg">
              Join thousands of traders using AI algorithms to eliminate emotion and maximize precision. Get started in
              a min
            </p>
          </div>
        ...
        <div class="flex justify-center lg:justify-end lg:pr-47 items-end lg:pt-24 overflow-hidden">
          <img src="/images/Call-To-Action.png" alt="Sindbad.Tech App Interface"
