  ...
  <section class="py-16 md:py-24 px-4 md:mt-24 sm:px-6 flex justify-center font-sans bg-background">
    <Card class="w-full max-w-6xl rounded-[2.5rem] shadow-sm border-border">
      <CardHeader class="text-center pb-12 md:pb-16 pt-8 md:pt-12">
        ...
        <CardDescription
          class="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed"
        >
      ...
      >
        <div class="flex flex-col space-y-10">
          <div class="space-y-5">
            <div class="flex justify-between items-center">
              <Label class="text-primary font-medium text-base"
        ...
        <div class="relative w-full h-[350px] lg:h-[400px] flex flex-col pt-6 lg:pt-0">
          <div class="absolute top-0 left-12 lg:left-14 z-10 pointer-events-none">
            ...
            >
            <span class="text-4xl md:text-5xl font-bold text-primary block">{{
              projectedTotal
            }}</span>
          </div>
          ...
          <div class="relative flex-1 mt-20 ml-12 lg:ml-14 mb-8">
            <div
              v-for="(grid, index) in chartData.yGrid"
              :key="'y-' + index"
            ...
            <div
              v-for="(grid, index) in chartData.xGrid"
              :key="'x-' + index"
            ...
            >
              ...
              <line
                :x1="chartData.circleX"
                :y1="chartData.circleY + 6"
                :x2="chartData.circleX"
                :y2="chartData.bottomBaseline"
                stroke="var(--blue)"
                stroke-width="2"
                opacity="0.5"
              />
              <circle
                :cx="chartData.circleX"
                :cy="chartData.circleY"
                r="6"
                fill="var(--background)"
                stroke="var(--blue)"
                stroke-width="3"
