      ...
      <nav class="mx-auto flex w-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-8 py-3 lg:py-4">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-between lg:gap-10">
          <div class="flex items-center gap-4">
            <LandingSectionsFeatureDropdown /> <!-- Display the FeatureDropDown bots-->
          ...
          <div class="flex items-center gap-3">
            <Button variant="default" size="lg" class="hover:bg-background hover:text-secondary cursor-pointer">
              Sign In
            </Button>
            <Button variant="default" size="lg" class="bg-secondary cursor-pointer text-white hover:bg-secondary/90">
              Sign Up</Button>
        ...
        <div v-if="isMobileNavOpen" class="lg:hidden">
          <div
            ...
            <div class="flex flex-col gap-4">
              <div v-for="navigation in navigations" :key="navigation.title"
